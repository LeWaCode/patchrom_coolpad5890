...
.field private static final DLL_STRING:Ljava/lang/String; = "DLL_test"
...
.field static final LCD_BRIGHTNESS_VALUE_PATH:Ljava/lang/String; = "/sys/class/leds/lcd-backlight/brightness"
...
.field static final NOTIFICATION_ID:I = 0x123

.field private static final TAG:Ljava/lang/String;

.field public static mAdjustScreenBrightness:I

.field private static mLastScreenBrightnessValue:I
...
.field mBrightnessValueHasChanged:Z
...
.field private mFullBatteryLevel:I
...
.field private mUnknownOnline:Z

.field private mUsbOnline:Z

.field mUserChaneBacklight:Z

.field private notificationHasSent:Z

.field notificationManger:Landroid/app/NotificationManager;
...
.method static constructor <clinit>()V
    ...
    .line 222
    sput v3, Lcom/android/server/BatteryService;->mLastScreenBrightnessValue:I

    .line 223
    sput v3, Lcom/android/server/BatteryService;->mAdjustScreenBrightness:I
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/LightsService;)V
    ...
    .line 174
    iput-object v4, p0, Lcom/android/server/BatteryService;->mTempDlg:Landroid/app/AlertDialog;

    .line 175
    iput-boolean v1, p0, Lcom/android/server/BatteryService;->mShowShutdownDialog:Z

    .line 176
    new-instance v0, Lcom/android/server/BatteryService$DialogHandler;

    invoke-direct {v0, p0}, Lcom/android/server/BatteryService$DialogHandler;-><init>(Lcom/android/server/BatteryService;)V

    iput-object v0, p0, Lcom/android/server/BatteryService;->mDialogHandler:Lcom/android/server/BatteryService$DialogHandler;

    .line 190
    iput-boolean v1, p0, Lcom/android/server/BatteryService;->haveUnreadMsg:Z

    .line 191
    iput-boolean v1, p0, Lcom/android/server/BatteryService;->haveMissedCall:Z

    .line 192
    iput-boolean v1, p0, Lcom/android/server/BatteryService;->isScreenOn:Z

    .line 193
    iput-boolean v1, p0, Lcom/android/server/BatteryService;->showMessageLight:Z

    .line 194
    iput-boolean v1, p0, Lcom/android/server/BatteryService;->showNumChanged:Z

    .line 195
    iput-boolean v1, p0, Lcom/android/server/BatteryService;->mBooted:Z
    ...
    iput-object v0, p0, Lcom/android/server/BatteryService;->handler:Landroid/os/Handler;
    ...
    iput-object v0, p0, Lcom/android/server/BatteryService;->lock:Ljava/lang/Object;

    .line 209
    iput-boolean v1, p0, Lcom/android/server/BatteryService;->notificationHasSent:Z

    .line 225
    iput-boolean v1, p0, Lcom/android/server/BatteryService;->mUserChaneBacklight:Z

    .line 226
    iput-boolean v1, p0, Lcom/android/server/BatteryService;->mBrightnessValueHasChanged:Z
    ...
    iput-object v0, p0, Lcom/android/server/BatteryService;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, Lcom/android/server/BatteryService;->mPowerManager:Landroid/os/PowerManager;
...
.method static synthetic access$100(Lcom/android/server/BatteryService;)Landroid/os/Handler;
    .locals 1
    .parameter "x0"

    .prologue
    .line 112
    iget-object v0, p0, Lcom/android/server/BatteryService;->handler:Landroid/os/Handler;
...
.method static synthetic access$1100(Lcom/android/server/BatteryService;)Z
    ...
    .prologue
    .line 112
    iget-boolean v0, p0, Lcom/android/server/BatteryService;->showNumChanged:Z
...
.method static synthetic access$1102(Lcom/android/server/BatteryService;Z)Z
    ...
    .prologue
    .line 112
    iput-boolean p1, p0, Lcom/android/server/BatteryService;->showNumChanged:Z
...
.method static synthetic access$1300(Lcom/android/server/BatteryService;)I
    ...
    .prologue
    .line 112
    iget v0, p0, Lcom/android/server/BatteryService;->batteryPlugg:I
...
.method static synthetic access$1302(Lcom/android/server/BatteryService;I)I
    ...
    .prologue
    .line 112
    iput p1, p0, Lcom/android/server/BatteryService;->batteryPlugg:I
...
.method static synthetic access$1400(Lcom/android/server/BatteryService;)I
    ...
    .prologue
    .line 112
    iget v0, p0, Lcom/android/server/BatteryService;->batteryStatus:I
...
.method static synthetic access$1402(Lcom/android/server/BatteryService;I)I
    ...
    .prologue
    .line 112
    iput p1, p0, Lcom/android/server/BatteryService;->batteryStatus:I
...
.method static synthetic access$1700(Lcom/android/server/BatteryService;)Z
    ...
    .prologue
    .line 112
    iget-boolean v0, p0, Lcom/android/server/BatteryService;->notificationHasSent:Z
...
.method static synthetic access$1702(Lcom/android/server/BatteryService;Z)Z
    ...
    .prologue
    .line 112
    iput-boolean p1, p0, Lcom/android/server/BatteryService;->notificationHasSent:Z

    return p1
.end method

.method static synthetic access$1800(Lcom/android/server/BatteryService;Ljava/lang/String;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 112
    invoke-direct {p0, p1}, Lcom/android/server/BatteryService;->playSound(Ljava/lang/String;)V
...
.method static synthetic access$2000()I
    ...
    .prologue
    .line 112
    sget v0, Lcom/android/server/BatteryService;->mLastScreenBrightnessValue:I
...
.method static synthetic access$2100(Lcom/android/server/BatteryService;)Lcom/android/server/LightsService$Light;
    .locals 1
    .parameter "x0"

    .prologue
    .line 112
    iget-object v0, p0, Lcom/android/server/BatteryService;->mLcdLight:Lcom/android/server/LightsService$Light;
...
.method static synthetic access$2200(Lcom/android/server/BatteryService;)Ljava/lang/Object;
    ...
    .prologue
    .line 112
    iget-object v0, p0, Lcom/android/server/BatteryService;->lock:Ljava/lang/Object;
...
.method static synthetic access$2900(Lcom/android/server/BatteryService;)Landroid/app/AlertDialog;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2902(Lcom/android/server/BatteryService;Landroid/app/AlertDialog;)Landroid/app/AlertDialog;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$3200(Lcom/android/server/BatteryService;)Landroid/os/PowerManager;
    .locals 1
    .parameter "x0"

    .prologue
    .line 112
    iget-object v0, p0, Lcom/android/server/BatteryService;->mPowerManager:Landroid/os/PowerManager;
...
.method static synthetic access$3300(Lcom/android/server/BatteryService;)I
    ...
    .prologue
    .line 112
    iget v0, p0, Lcom/android/server/BatteryService;->mFullBatteryLevel:I
...
.method static synthetic access$400(Lcom/android/server/BatteryService;)Ljava/lang/String;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$402(Lcom/android/server/BatteryService;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$500(Lcom/android/server/BatteryService;)Ljava/lang/String;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$502(Lcom/android/server/BatteryService;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$600(Lcom/android/server/BatteryService;)Ljava/lang/String;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$602(Lcom/android/server/BatteryService;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private final batteryTempOutOfRange()Z
    .locals 2
...
.method private playSound(Ljava/lang/String;)V
    ...
    invoke-direct {v0, p0, p1}, Lcom/android/server/BatteryService$2;-><init>(Lcom/android/server/BatteryService;Ljava/lang/String;)V

    invoke-virtual {v0}, Lcom/android/server/BatteryService$2;->start()V
...
.method private processValues()V
    ...
    .line 793
    :cond_f
    iget-boolean v0, p0, Lcom/android/server/BatteryService;->mUnknownOnline:Z
...
.method private shutdownConfirm(Z)V
    ...
    const-string v4, " mSentLowBatteryBroadcast = "
...
.method private final shutdownIfNoPower()V
    ...
    const-string v2, "shutdownIfNoPower boot="
    ...
    .line 707
    invoke-direct {p0, v3}, Lcom/android/server/BatteryService;->shutdownConfirm(Z)V

    goto :goto_0

    .line 709
    :cond_1
    invoke-direct {p0, v4}, Lcom/android/server/BatteryService;->shutdownConfirm(Z)V
...
.method private final shutdownIfOverTemp()V
    ...
    .line 763
    iget-object v1, p0, Lcom/android/server/BatteryService;->mTempDlg:Landroid/app/AlertDialog;
    ...
    iput-object v1, p0, Lcom/android/server/BatteryService;->mTempDlg:Landroid/app/AlertDialog;
...
# virtual methods
.method public adjustScreenBrightnessValue(Landroid/content/Context;)V
    .locals 7
    .parameter "context"
    ...
    .line 401
    invoke-virtual {p0}, Lcom/android/server/BatteryService;->getCurrentScreenbrightness()I

    move-result v0

    .line 402
    .local v0, currentScreenBrightness:I
    sput v0, Lcom/android/server/BatteryService;->mLastScreenBrightnessValue:I
    ...
    sput v2, Lcom/android/server/BatteryService;->mAdjustScreenBrightness:I

    .line 406
    iput-boolean v3, p0, Lcom/android/server/BatteryService;->mBrightnessValueHasChanged:Z
    ...
    .line 413
    sput v4, Lcom/android/server/BatteryService;->mAdjustScreenBrightness:I
    ...
    .line 417
    :cond_2
    iget-boolean v2, p0, Lcom/android/server/BatteryService;->mBrightnessValueHasChanged:Z

    if-eqz v2, :cond_3

    .line 418
    iget-object v2, p0, Lcom/android/server/BatteryService;->mLcdLight:Lcom/android/server/LightsService$Light;

    sget v3, Lcom/android/server/BatteryService;->mAdjustScreenBrightness:I
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string v1, "  Unknown powered: "

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-boolean v1, p0, Lcom/android/server/BatteryService;->mUnknownOnline:Z
...
.method public getAdjustScreenBrightnessValue()I
    .locals 1

    .prologue
    .line 428
    sget v0, Lcom/android/server/BatteryService;->mAdjustScreenBrightness:I
...
.method public getCurrentScreenbrightness()I
    ...
    .line 383
    .local v1, buffer:[C
    new-instance v5, Lcom/android/server/LightsService;

    iget-object v6, p0, Lcom/android/server/BatteryService;->mContext:Landroid/content/Context;

    invoke-direct {v5, v6}, Lcom/android/server/LightsService;-><init>(Landroid/content/Context;)V

    invoke-virtual {v5, v7}, Lcom/android/server/LightsService;->getLight(I)Lcom/android/server/LightsService$Light;

    move-result-object v5

    iput-object v5, p0, Lcom/android/server/BatteryService;->mLcdLight:Lcom/android/server/LightsService$Light;
    ...
    const-string v6, "The brightness file not exist !!/sys/class/leds/lcd-backlight/brightness"
...
.method final isPowered(I)Z
    ...
    .line 601
    :cond_4
    iget-boolean v3, p0, Lcom/android/server/BatteryService;->mUnknownOnline:Z
...
.method public sendNotification(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/String;Landroid/app/PendingIntent;)V
    .locals 4
    .parameter "context"
    .parameter "prompt"
    .parameter "suggest"
    ...
    iput-object v1, p0, Lcom/android/server/BatteryService;->notificationManger:Landroid/app/NotificationManager;
    ...
    invoke-virtual {v0, v1, v2, p3, p4}, Landroid/app/Notification;->setLatestEventInfo(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/app/PendingIntent;)V

    .line 373
    iget-object v1, p0, Lcom/android/server/BatteryService;->notificationManger:Landroid/app/NotificationManager;
