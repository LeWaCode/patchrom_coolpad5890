...
.method static constructor <clinit>()V
    ...
    .line 447
    sput-object v4, Landroid/media/AudioService;->oSystemManager:Ljava/lang/Object;

    .line 448
    sput-object v4, Landroid/media/AudioService;->mGetCurrentModel:Ljava/lang/reflect/Method;

    .line 449
    sput v3, Landroid/media/AudioService;->c_quietmode:I

    .line 450
    sput v3, Landroid/media/AudioService;->c_meetingmode:I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    const-string v3, "AudioService ctor mVoiceCapable:"
    ...
    .line 605
    :cond_1
    const-string/jumbo v0, "yulong.intent.action.AIDPACK_SWITCH"
    ...
    const-string/jumbo v3, "mMasterVolumeRamp.length "
...
.method private dispatchMediaKeyEventForCalls(Landroid/view/KeyEvent;Z)V
    ...
    const-string v4, "dispatchMediaKeyEventForCalls "
...
.method private filterMediaKeyEvent(Landroid/view/KeyEvent;Z)V
    ...
    const-string v2, "filterMediaKeyEvent "
...
.method private filterVoiceInputKeyEvent(Landroid/view/KeyEvent;Z)V
    ...
    .line 4557
    :cond_3
    const-string/jumbo v2, "yulong.audio.electric.test"
    ...
    .line 4558
    invoke-direct {p0, p1, p2}, Landroid/media/AudioService;->startAudioElectricButtonTest(Landroid/view/KeyEvent;Z)V
    ...
    const-string v4, "   ignore key event"
    ...
    const-string v4, "   start voice-based interactions"
    ...
    const-string v4, "   send simulated key event"
...
.method private getActiveStreamType(I)I
    ...
    .line 2555
    const-string/jumbo v6, "qc_8x25"

    const-string/jumbo v7, "qc_8x25"
    ...
    .line 2557
    .local v0, isVtOn:Z
    const-string/jumbo v6, "is_video_telephony_on"
    ...
    const-string/jumbo v6, "is_video_telephony_on=1"
    ...
    const-string v4, "getActiveStreamType: Forcing STREAM_REMOTE_MUSIC"
    ...
    const-string v3, "getActiveStreamType: using STREAM_MUSIC as default"
...
.method private onSetWiredDeviceConnectionState(IILjava/lang/String;)V
    ...
    const-string v6, "c_quietmode "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    sget v6, Landroid/media/AudioService;->c_quietmode:I

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v5

    const-string v6, " c_meetingmode "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    sget v6, Landroid/media/AudioService;->c_meetingmode:I

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v5

    const-string v6, " mode_cur "
    ...
    const-string v5, "In quiet or meeting mode,headset plugin"
    ...
    invoke-direct {p0, v1, p1, v2}, Landroid/media/AudioService;->handleDeviceConnection(ZILjava/lang/String;)Z
    ...
    const-string v5, "In quiet or meeting mode,headset plugout"
...
.method private pushMediaButtonReceiver(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    ...
    const-string/jumbo v5, "pushMediaButtonReceiver "
...
.method private removeMediaButtonReceiver(Landroid/app/PendingIntent;)V
    ...
    const-string/jumbo v3, "removeMediaButtonReceiver"
...
.method private removeMediaButtonReceiverForPackage(Ljava/lang/String;)V
    ...
    const-string/jumbo v6, "removeMediaButtonReceiverForPackage "
...
.method private restoreMediaButtonReceiver()V
    ...
    const-string/jumbo v6, "restoreMediaButtonReceiver "
...
.method private setRingerModeInt(IZ)V
    ...
    const-string/jumbo v3, "setRingerModeInt streamType:"
    ...
    const-string v3, " is muted by ringer mode"
    ...
    const-string v3, " is not affected by ringer mode"
...
.method private startAudioElectricButtonTest(Landroid/view/KeyEvent;Z)V
    .locals 4
    .parameter "keyEvent"
    .parameter "needWakeLock"
    ...
    .line 4591
    .local v0, audioelectricIntent:Landroid/content/Intent;
    new-instance v0, Landroid/content/Intent;

    .end local v0           #audioelectricIntent:Landroid/content/Intent;
    const-string/jumbo v1, "yulong.intent.action.audioelectric.test"

    invoke-direct {v0, v1}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 4593
    .restart local v0       #audioelectricIntent:Landroid/content/Intent;
    ...
    const-string/jumbo v3, "mContext.sendBroadcast(audioelectricIntent)    "
...
.method public adjustStreamVolume(III)V
    ...
    const-string v6, "can not adjust stream volume in quiet or meeting mode!"
    ...
    .line 862
    .end local v23           #scenemodelmetting:Z
    .end local v24           #scenemodelquiet:Z
    :cond_1
    const/16 v24, 0x0
    ...
    .line 863
    .restart local v24       #scenemodelquiet:Z
    :cond_2
    const/16 v23, 0x0
    ...
    .line 875
    .restart local v23       #scenemodelmetting:Z
    :cond_3
    move-object/from16 v0, p0
...
.method public dispatchMediaKeyEventUnderWakelock(Landroid/view/KeyEvent;)V
    ...
    const-string v2, "dispatchMediaKeyEventUnderWakelock "
...
.method public registerMediaButtonEventReceiverForCalls(Landroid/content/ComponentName;)V
    ...
    const-string/jumbo v3, "registerMediaButtonEventReceiverForCalls"
...
.method public setRingerMode(I)V
    ...
    const-string/jumbo v2, "setRingerMode ringerMode:"
...
.method public unregisterMediaButtonEventReceiverForCalls()V
    ...
    const-string/jumbo v2, "unregisterMediaButtonEventReceiverForCalls"
