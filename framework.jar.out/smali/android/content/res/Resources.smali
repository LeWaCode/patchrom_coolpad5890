...
.method private clearDrawableCacheExt(Landroid/util/LongSparseArray;)V
    .locals 5
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method private clearDrawableCacheExtSys(Landroid/util/LongSparseArray;)V
    .locals 4
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .line 1621
    .local v2, ref:Landroid/graphics/drawable/Drawable$ConstantState;
    if-eqz v2, :cond_0

    .line 1622
    const/4 v3, 0x0

    invoke-virtual {p1, v1, v3}, Landroid/util/LongSparseArray;->setValueAt(ILjava/lang/Object;)V
    ...
    .line 1625
    .end local v2           #ref:Landroid/graphics/drawable/Drawable$ConstantState;
    :cond_1
    return-void
.end method
...
.method private getYLThemeColor(Ljava/lang/String;Ljava/lang/String;)I
    ...
    .line 2629
    .local v3, uitechnoService:Landroid/os/IBinder;
    iget-boolean v6, p0, Landroid/content/res/Resources;->mPreloading:Z
    ...
    .line 2635
    invoke-direct {p0, p1, p2}, Landroid/content/res/Resources;->getYLThemePackageProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private getYLThemePackageProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 2723
    :cond_1
    iget-object v2, p0, Landroid/content/res/Resources;->mYLThemePropertiesMap:Ljava/util/HashMap;
    ...
    iput-object v2, p0, Landroid/content/res/Resources;->mYLThemePropertiesMap:Ljava/util/HashMap;

    .line 2726
    :cond_2
    iget-object v2, p0, Landroid/content/res/Resources;->mYLThemeLoadedPackages:Ljava/util/HashSet;
    ...
    iput-object v2, p0, Landroid/content/res/Resources;->mYLThemeLoadedPackages:Ljava/util/HashSet;
...
.method private loadYLThemePackageProperty(Ljava/lang/String;)V
    ...
    const-string/jumbo v8, "loadYLThemePackageProperty() "
...
.method public clearCache()V
    ...
    .line 2589
    iget-object v0, p0, Landroid/content/res/Resources;->mColorCache:Ljava/util/HashMap;
...
.method public clearCache(I)V
    ...
    .line 2566
    iget-object v3, p0, Landroid/content/res/Resources;->mColorDrawableCache:Landroid/util/LongSparseArray;
    ...
    .line 2572
    iget-object v3, p0, Landroid/content/res/Resources;->mColorCache:Ljava/util/HashMap;
...
.method public flushResCache()V
    ...
    invoke-direct {p0, v0}, Landroid/content/res/Resources;->clearDrawableCacheExt(Landroid/util/LongSparseArray;)V
    ...
    invoke-direct {v0, v1}, Landroid/content/res/Resources;->clearDrawableCacheExtSys(Landroid/util/LongSparseArray;)V
...
.method loadColorStateList(Landroid/util/TypedValue;I)Landroid/content/res/ColorStateList;
    ...
    .restart local v0       #csl:Landroid/content/res/ColorStateList;
    :cond_1
    invoke-direct {p0, p2, p1}, Landroid/content/res/Resources;->getYLThemeColor(ILandroid/util/TypedValue;)I

    move-result v8

    .line 2221
    .local v8, ylThemeColor:I
    if-eqz v8, :cond_3
...
.method loadDrawable(Landroid/util/TypedValue;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v13, v6}, Landroid/content/res/Resources;->getYLThemeResourceStream(Ljava/lang/String;Ljava/lang/String;)Ljava/io/InputStream;
