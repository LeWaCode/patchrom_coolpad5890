...
.method private initAbsListView()V
    ...
    invoke-direct {p0, v1, v2}, Landroid/widget/AbsListView;->initVelocityConfiguration(IF)V
...
.method private initVelocityConfiguration(IF)V
    ...
    const-string/jumbo v7, "maximumVelocity"

    .line 840
    .local v7, maxVelocityKey:Ljava/lang/String;
    const-string/jumbo v11, "velocityScale"

    .line 843
    .local v11, velocityScaleKey:Ljava/lang/String;
    const/16 v1, 0x301

    .line 845
    .local v1, CODE_PROPERTYSERVICE_GETPROPERTY:I
    const/4 v6, 0x0

    .line 847
    .local v6, mUitechnoService:Landroid/os/IBinder;
    :try_start_0
    const-string/jumbo v13, "uitechnoService"
    ...
    .line 856
    .local v3, data1:Landroid/os/Parcel;
    invoke-static {}, Landroid/os/Parcel;->obtain()Landroid/os/Parcel;

    move-result-object v9

    .line 858
    .local v9, reply1:Landroid/os/Parcel;
    :try_start_1
    ...
    invoke-interface {v6, v13, v3, v9, v14}, Landroid/os/IBinder;->transact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 862
    .local v8, maxVelocityValue:Ljava/lang/String;
    if-eqz v8, :cond_1
    ...
    iput v13, p0, Landroid/widget/AbsListView;->mMaximumVelocity:I
    :try_end_1
    ...
    .line 874
    .end local v8           #maxVelocityValue:Ljava/lang/String;
    :goto_3
    ...
    .line 880
    .local v10, reply2:Landroid/os/Parcel;
    :try_start_2
    ...
    invoke-interface {v6, v13, v4, v10, v14}, Landroid/os/IBinder;->transact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 884
    .local v12, velocityScaleValue:Ljava/lang/String;
    if-eqz v12, :cond_2
    ...
    iput v13, p0, Landroid/widget/AbsListView;->mVelocityScale:F
    :try_end_2
    ...
    .line 895
    .end local v12           #velocityScaleValue:Ljava/lang/String;
    :goto_5
    ...
    .end local v10           #reply2:Landroid/os/Parcel;
    .restart local v8       #maxVelocityValue:Ljava/lang/String;
    :cond_1
    :try_start_3
    move/from16 v0, p1
    ...
    .restart local v10       #reply2:Landroid/os/Parcel;
    .restart local v12       #velocityScaleValue:Ljava/lang/String;
    :cond_2
    :try_start_5
    move/from16 v0, p2

    iput v0, p0, Landroid/widget/AbsListView;->mVelocityScale:F
    :try_end_5
