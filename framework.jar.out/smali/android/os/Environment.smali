...
.field private static volatile EXTERNAL_APP_STORAGE_DIRECTORY:Ljava/io/File; = null
...
.field public static final MEDIA_NO_SPACE:Ljava/lang/String; = "no_space"
...
.method static constructor <clinit>()V
    ...
    .line 45
    sput-object v4, Landroid/os/Environment;->mPrimaryVolume:Landroid/os/storage/StorageVolume;
    ...
    .line 244
    sput-object v4, Landroid/os/Environment;->EXTERNAL_APP_STORAGE_DIRECTORY:Ljava/io/File;
...
.method private static getExternalAppStorageDirectory()Ljava/io/File;
    .locals 8
    ...
    .line 246
    sget-object v5, Landroid/os/Environment;->EXTERNAL_APP_STORAGE_DIRECTORY:Ljava/io/File;
    ...
    .line 255
    .local v3, volumeSecond:Landroid/os/storage/StorageVolume;
    ...
    sput-object v5, Landroid/os/Environment;->EXTERNAL_APP_STORAGE_DIRECTORY:Ljava/io/File;
    ...
    .end local v3           #volumeSecond:Landroid/os/storage/StorageVolume;
    ...
    const-string v6, "fail to get, return EXTERNAL_STORAGE_DIRECTORY"

    invoke-static {v5, v6}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 276
    sget-object v5, Landroid/os/Environment;->EXTERNAL_STORAGE_DIRECTORY:Ljava/io/File;
...
.method private static getExternalStorageDirectoryAsecInExternalSdcard()Ljava/io/File;
    .locals 8
    ...
    const-string/jumbo v7, "uid < 10000, return path:"

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    sget-object v7, Landroid/os/Environment;->EXTERNAL_STORAGE_DIRECTORY:Ljava/io/File;
    ...
    invoke-interface {v3, v2, v5, v6}, Landroid/content/pm/IPackageManager;->getApplicationInfo(Ljava/lang/String;II)Landroid/content/pm/ApplicationInfo;
    ...
    const-string v7, "GetExternalStorageDirectory info:"
    ...
    const-string v6, "This apk install on sd and we call getExternalAppStorageDirectory()!"

    invoke-static {v5, v6}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 230
    invoke-static {}, Landroid/os/Environment;->getExternalAppStorageDirectory()Ljava/io/File;
    :try_end_0
...
.method private static getExternalStorageDirectoryAsecInInnerSdcard()Ljava/io/File;
    .locals 1
...
.method public static getExternalStorageState()Ljava/lang/String;
    ...
    .line 541
    .local v0, ExternalDirectory:Ljava/io/File;
    ...
    const-string v5, "Enviroment getExternalStorageState :"
    ...
    .line 546
    .end local v0           #ExternalDirectory:Ljava/io/File;
    :goto_0
    return-object v3
