...
.field private static final MSG_BRIGHTNESS_CHANGE:I = 0x1
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/ViewManager;Lcom/android/internal/policy/impl/KeyguardViewCallback;Lcom/android/internal/policy/impl/KeyguardViewProperties;Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;)V
    ...
    .line 267
    new-instance v0, Lcom/android/internal/policy/impl/KeyguardViewManager$2;

    invoke-direct {v0, p0}, Lcom/android/internal/policy/impl/KeyguardViewManager$2;-><init>(Lcom/android/internal/policy/impl/KeyguardViewManager;)V

    iput-object v0, p0, Lcom/android/internal/policy/impl/KeyguardViewManager;->mHandler:Landroid/os/Handler;
...
.method static synthetic access$100(Lcom/android/internal/policy/impl/KeyguardViewManager;)Landroid/os/Handler;
    .locals 1
    .parameter "x0"

    .prologue
    .line 53
    iget-object v0, p0, Lcom/android/internal/policy/impl/KeyguardViewManager;->mHandler:Landroid/os/Handler;
...
.method public setBrightNess()V
    ...
    iput v2, p0, Lcom/android/internal/policy/impl/KeyguardViewManager;->brightNess:I

    .line 253
    const-string v2, "KeyguardViewManager"
    ...
    iget v4, p0, Lcom/android/internal/policy/impl/KeyguardViewManager;->brightNess:I
    ...
    .line 254
    iget v2, p0, Lcom/android/internal/policy/impl/KeyguardViewManager;->brightNess:I
    ...
    const-string v4, "...................lp.screenBrightness1="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-object v4, p0, Lcom/android/internal/policy/impl/KeyguardViewManager;->mWindowLayoutParams:Landroid/view/WindowManager$LayoutParams;
    ...
    const-string v4, "...................lp.screenBrightness2="
    ...
    iget v3, p0, Lcom/android/internal/policy/impl/KeyguardViewManager;->brightNess:I
    ...
    const-string v4, "...................lp.screenBrightness3="
    ...
    const-string v3, " it is exception setBrightNess"
...
.method public setContentObserver()V
    .locals 5
    ...
    .line 236
    .local v0, brightNessInfo:Ljava/lang/String;
    new-instance v1, Lcom/android/internal/policy/impl/KeyguardViewManager$1;

    iget-object v2, p0, Lcom/android/internal/policy/impl/KeyguardViewManager;->mHandler:Landroid/os/Handler;

    invoke-direct {v1, p0, v2}, Lcom/android/internal/policy/impl/KeyguardViewManager$1;-><init>(Lcom/android/internal/policy/impl/KeyguardViewManager;Landroid/os/Handler;)V
